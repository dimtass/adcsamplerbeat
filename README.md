...
`${GOPATH}/src/github.com/dimtass/adcsamplerbeat`
...
```
git remote set-url origin https://github.com/dimtass/adcsamplerbeat
...
in the same directory with the name adcsamplerbeat.
...
```
./adcsamplerbeat -c adcsamplerbeat.yml -e -d "*"
```
...
```
mkdir -p ${GOPATH}/src/github.com/dimtass/adcsamplerbeat
git clone https://github.com/dimtass/adcsamplerbeat ${GOPATH}/src/github.com/dimtass/adcsamplerbeat
```
